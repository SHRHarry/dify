const translation = {
  pageTitle: '嗨，近來可好',
  welcome: '👋 歡迎來到 小達, 登入以繼續',
  email: '帳號',
  emailPlaceholder: '輸入帳號',
  password: '密碼',
  ...
  goToInit: '如果您還沒有初始化帳戶，請前往初始化頁面',
  dontHave: '還沒有邀請碼？',
  invalidInvitationCode: '無效的邀請碼',
  accountAlreadyInited: '帳戶已經初始化',
  forgotPassword: '忘記密碼？',
  ...
  withSSO: '繼續使用 SSO',
  back: '返回',
  resetPasswordDesc: '輸入您用於註冊 小達 的電子郵件，我們將向您發送一封密碼重置電子郵件。',
  usePassword: '使用密碼',
